...
class UserRepository extends ServiceEntityRepository implements PasswordUpgraderInterface, UserLoaderInterface
{
  ...
  public function getAllPublicUsers(int $page = 1, int $itemsPerPage = 30): DoctrinePaginator|Exception
  ...
  public function checkIfEmailAvailable($email,$user_id): ?User
  {
    ...
    return ($queryBuilder)
      ...
      ->andWhere(
        $queryBuilder->expr()->orX(
          ...
          $queryBuilder->expr()->eq('u.unverified_email', ':email')
        )
      )
