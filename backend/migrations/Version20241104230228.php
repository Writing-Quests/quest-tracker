 ...
 */
final class Version20241104230228 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE report ADD CONSTRAINT FK_C42F7784B79DEF28 FOREIGN KEY (reported_by_user_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
