      ...
      <ContentContainer>
        ...
        <ul>
          ...
          <li>We cannot account for the content or behavior of third-party links shared on another user&apos;s profile.
            <ul>
              <li>Accounts may be removed from the service for violating </li>
            </ul>
          </li>
        ...
        <p>This Privacy Policy describes the Questy Writing Tracker policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.</p>
        ...
        <ul>
          ...
          <li><strong>Organization</strong> (referred to as either &quot;the Organization&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Questy Writing Tracker.</li>
          ...
          <li><strong>Service Provider</strong> means any natural or legal person who processes the data on behalf of the Organization. It refers to third-party companies or individuals employed by the Organization to facilitate the Service, to provide the Service on behalf of the Organization, to perform services related to the Service or to assist the Organization in analyzing how the Service is used.</li>
          <li><strong>Usage Data</strong> refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</li>
          <li><strong>Website</strong> refers to Questy Writing Tracker, accessible from <a href="https://questy.writingquests.org" rel="external nofollow noopener" target="_blank">https://questy.writingquests.org</a></li>
        </ul>
        ...
        <StyledTable>
          <tbody>
            <tr>
              <th colSpan="2">Necessary / Essential Cookies</th>
            </tr>
            <tr>
              <th>Type</th>
        ...
        <StyledTable>
          <tbody>
            <tr>
              <th colSpan="2">Cookies Policy / Notice Acceptance Cookies</th>
            </tr>
            <tr>
              <th>Type</th>
        ...
        <StyledTable>
          <tbody>
            <tr>
              <th colSpan="2">Functionality Cookies</th>
            </tr>
            <tr>
              <th>Type</th>
              <td>Persistent Cookies</td>
        ...
        <p>Your information, including Personal Data, is processed on behalf of the Organization&apos; by volunteer staff in any other places where the parties involved in the processing are located. It means that this information may be transferred to — and maintained on — computers located outside of Your state, province, country or other governmental jurisdiction where the data protection laws may differ than those from Your jurisdiction.</p>
        ...
        <ul>
        <li>By email: <a href="mailto:secretary@writingquests.org">secretary@writingquests.org</a></li>
        </ul>
        <SubText>This Privacy Policy has been created with the help of the <a href="https://www.privacypolicies.com/privacy-policy-generator/" target="_blank">Privacy Policy Generator</a>.</SubText>
        </ContentBlock>
      </ContentContainer>
    </Page>
  )
